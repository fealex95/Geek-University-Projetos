...
def efetuar_deposito() -> None:
    if len(contas) > 0:
        ...
        if conta: 
            ...
            print(f'Não foi encontrada nenhuma conta {numero}')
    else:
...
def efetuar_transferencia() -> None:
    if len(contas) > 1:
        numero_origem: int = int(input('Informe o numero da conta de origem: '))
        ...
        print('Não existem contas suficientes para realizar esta operação')
